    ...
    <section class="get-in-touch">
        ...
        <form id="form" class="contact-form row" action="loginprocess.php" method="post" >
            <div class="form-field col-lg-7 ">
                <input id="email" class="input-text js-input" type="email" required name="emailuser">
                <label class="label" for="email">E-mail</label>
            </div>
            
            <div class="form-field col-lg-7 ">
                <input id="pass" class="input-text js-input" type="password" required name="passuser">
