            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a  id="hos2" class="nav-link active" href="search.php?selected%5B%5D=ICU&selected%5B%5D=Normal+Beds&selected%5B%5D=Oxygen&selected%5B%5D=Ventilator" >Availability</a>
                    </li>
                    <li class="nav-item active">
